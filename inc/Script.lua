...
if (MsgText[1] == "منشن للحلوين"or MsgText[1]=="تاك للمنشئيين" and is_JoinChannel(msg)) then 
if not msg.Admin then return " ⋆  ⇽ هذا الامر يخص : الادمن ⇽ المدير ⇽ المنشئ ⇽ المطور فقط \n⋆" end
return ownerlist(msg) .. GetListAdmin(msg) .. whitelist(msg)
end

if MsgText[1] == "منشن للكل" or MsgText[1]=="تاك للكل"then 
if not msg.Admin then return "  ⋆  ⇽ هذا الامر يخص :\n الادمن ⇽ المدير ⇽ المنشئ ⇽ المطور فقط \n⋆ " end
return ownerlist(msg) .. GetListAdmin(msg) .. whitelist(msg)
end
...
local inline = {{{text="قناة السورس .",url="t.me/@TH3NEK"}}}
send_key(msg.sender_user_id_,'[ قناة سورس max .](t.me/@TH3NEK)',nil,inline,msg.id_)
return false
end
...
▿↜ قــنــاة الـسـورس⇦ [ســورس  النيزك.](t.me/TH3NEK)
 ☄
⋆ ⋆ ⋆ ⋆ ⋆⋆ ⋆ ⋆ ⋆ ⋆⋆ ⋆ ⋆ ⋆ ⋆⋆ ⋆ ⋆ ⋆ ⋆⋆ ⋆ ⋆ ⋆ ⋆
⠀⠀
]]
...
local su = {
  ...
  elseif Text== "مالك السورس" then return sendMsg(msg.chat_id_,msg.id_,"[⇽ علي محمد](t.me/TH3SS")
  elseif Text== "مطور السورس" then return sendMsg(msg.chat_id_,msg.id_,"[⇽ بــاســل ᐂ](t.me/xb_1b")
  elseif Text== "باسل" then return sendMsg(msg.chat_id_,msg.id_,"[بــاســل ᐂ](t.me/xb_1b")
  elseif Text== "علي محمد" then return sendMsg(msg.chat_id_,msg.id_,"[مطـور سورس النيزك](t.me/TH3SS")
