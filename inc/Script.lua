...
if MsgText[2] == "ردود النيزك"   then return unlock_replay(msg) end
if MsgText[2] == "الاذاعه"  then return unlock_brod(msg) end
if MsgText[2] == "ايدي النيزك"   then return unlock_IID(msg) end
if MsgText[2] == "ترحيب النيزك"  then return unlock_Welcome(msg) end
...
if MsgText[2] == "ردود النيزك"   then return lock_replay(msg) end
if MsgText[2] == "الاذاعه"  then return lock_brod(msg) end
if MsgText[2] == "ايدي النيزك"   then return lock_IID(msg) end
if MsgText[2] == "ترحيب النيزك"  then return lock_Welcome(msg) end
...
sendMsg(msg.chat_id_,msg.id_,'↫ عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس النيزك يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❕')
end  
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/THTSS"}}}
send_key(msg.sender_user_id_,'  [-قناة سورس : النيزك ل](https://t.me/THTSS)',nil,inline,msg.id_)
return false
end
...
return [[
▿↜ مــطــور الــســورس  ⇦ [م علي محمد](t.me/TH3SS)
▿↜ قــنــاة الـسـورس⇦ [ســورس  النيزك.](t.me/THTSS)
 ☄
 ♠
]]
end
...
local colors = {'blue','green','yellow','magenta','OTHTSSe','DarkOTHTSSe','red'}
...
elseif Text== "علي محمد" then return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس](t.me/THTSS .")
