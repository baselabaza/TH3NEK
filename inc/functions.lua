...
download_file('https://raw.githubusercontent.com/THTSS/boos/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/THTSS/boos/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/THTSS/boos/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/THTSS/boos/master/inc/functions.lua','./inc/functions.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'100% - |█████████████|\n\n🔝*¦* تم تحديث السورس الى اصدار *v'..redis:get(boos..":VERSION")..'*\n📟*¦* تم اعاده تشغيل السورس بنجاح') end
if edit then dofile("./inc/Run.lua") end
print("Update Source And Reload ~ ./inc/Run.lua")

end
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(boos..":NameBot:") or "النيزك"
...
usernn = data.username_ or "THTSS"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "THTSS"
end
Name = Name:gsub('[[][]]','')
...
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(boos..':MONSHA_Group:'..ChatID,UserID) then
var = ' المنشىء اساسي👷🏽' 
elseif redis:sismember(boos..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء 👷🏽' 
elseif redis:sismember(boos..'owners:'..ChatID,UserID) then
var = 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(boos..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(boos..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
...
if msg.edited then
redis:incr(boos..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info_ then
redis:incr(boos..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.content_.ID == "MessageChatAddMembers" then 
redis:incr(boos..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessagePhoto" then
redis:incr(boos..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageSticker" then
redis:incr(boos..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVoice" then
redis:incr(boos..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAudio" then
redis:incr(boos..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVideo" then
redis:incr(boos..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAnimation" then
redis:incr(boos..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
function TagAll(msg)
  ...
  local monshaas = redis:smembers(boos..':MONSHA_Group:'..msg.chat_id_)
  local monsha = redis:smembers(boos..':MONSHA_BOT:'..msg.chat_id_)
  local Owners = redis:smembers(boos..'owners:'..msg.chat_id_)
  local Admins = redis:smembers(boos..'admins:'..msg.chat_id_)
  local mmez = redis:smembers(boos..'whitelist:'..msg.chat_id_)
...
for k,v in pairs(mmez) do
  if not message:match(v) then
    local info  = redis:hgetall(boos..'username:'..v)
...
local list = redis:smembers(boos..':SUDO_BOT:')
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`★`*_* ['..SUDO_USER..'] ➣ (' ..SUDO_ID.. '){'..redis:scard(boos..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info  = redis:hgetall(boos..'username:'..v)
local count = redis:scard(boos..'mtwr_count'..v)
...
function conslist(msg)
    ...
    local monsha = redis:smembers(boos..':MONSHA_Group:'..msg.chat_id_)
    if #monsha == 0 then 
...
local list = redis:smembers(boos..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(boos..'admins:'..msg.chat_id_)
...
local list = redis:smembers(boos..'whitelist:'..msg.chat_id_)
...
if redis:sismember(boos..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(boos..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(boos..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(boos..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(boos..'gban_users')
...
function FilterX(msg,text)
  text = tostring(text)
  local var = false
local list = redis:smembers(boos..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(boos..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*¦* الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(boos..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(boos..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(boos..':Filter_Word:'..msg.chat_id_,word) 
...
local NumberFlood = tonumber(redis:get(boos..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then 
result = false
else
redis:setex(boos..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
json_data = '{"BotID": '..boos..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(boos..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(boos..'group:name'..GroupS) or '')
...
local admins = redis:smembers(boos..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(boos..'username:'..value)
if info then 
...
local creator = redis:smembers(boos..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(boos..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(boos..'group:ids')
message = '📋*¦* قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(boos..'group:name'..v)
if info then 
...
redis:del(
boos..'group:add'..id_group,
boos..'lock_link'..id_group, 
boos..'lock_id'..id_group,
boos..'lock_spam'..id_group, 
boos..'lock_webpage'..id_group,
boos..'lock_markdown'..id_group,
boos..'lock_flood'..id_group,
boos..'lock_bots'..id_group,
boos..'mute_forward'..id_group,
boos..'mute_contact'..id_group,
boos..'mute_location'..id_group,
boos..'mute_document'..id_group,
boos..'mute_keyboard'..id_group,
boos..'mute_game'..id_group,
boos..'mute_inline'..id_group,
boos..'lock_username'..id_group,
boos..'num_msg_max'..id_group,
boos..'mute_text'..id_group,
boos..'admins:'..id_group,
boos..':Filter_Word:'..id_group,
boos..'banned:'..id_group,
boos..'is_silent_users:'..id_group,
boos..'whitelist:'..id_group,
boos..':MONSHA_BOT:'..id_group,
boos..'owners:'..id_group,
boos..'replay'..id_group,
boos..':MONSHA_Group:'..id_group
)
redis:srem(boos..'group:ids',id_group)
end
...
NumAdmin = NumAdmin + 1
if not redis:sismember(boos..'admins:'..arg.chat_id_,v.user_id_) then
GetUserID(v.user_id_,function(arg,data)
redis:hset(boos..'username:'..data.id_,'username',ResolveUserName(data))
redis:sadd(boos..'admins:'..arg.chat_id_,data.id_)
...
if redis:get(boos..'group:add'..msg.chat_id_) then  return '🎗*¦* المجموعه بالتأكيد ✓️ تم تفعيلها' end
...
local GroupUsers = tonumber(redis:get(boos..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(boos..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(boos..':MONSHA_Group:'..arg.chat_id_,data.id_)
...
redis:mset(
boos..'group:add'..arg.chat_id_,true,
boos..'lock_link'..arg.chat_id_,true, 
boos..'lock_id'..arg.chat_id_,true,
boos..'lock_spam'..arg.chat_id_,true,
boos..'lock_webpage'..arg.chat_id_,true,
boos..'lock_markdown'..arg.chat_id_,true,
boos..'lock_flood'..arg.chat_id_,true,
boos..'lock_bots'..arg.chat_id_,true,
boos..'mute_forward'..arg.chat_id_,true,
boos..'mute_contact'..arg.chat_id_,true,
boos..'mute_location'..arg.chat_id_,true,
boos..'mute_document'..arg.chat_id_,true,
boos..'mute_keyboard'..arg.chat_id_,true,
boos..'mute_game'..arg.chat_id_,true,
boos..'mute_inline'..arg.chat_id_,true,
boos..'lock_username'..arg.chat_id_,true,
boos..'num_msg_max'..arg.chat_id_,5, 
boos..'lock_edit'..arg.chat_id_,true,
boos..'replay'..arg.chat_id_,true,
boos.."lock_KickBan"..msg.chat_id_,true,
boos.."lock_mmno3"..msg.chat_id_,true,
boos.."lock_linkk"..msg.chat_id_,true
)
redis:sadd(boos..'group:ids',arg.chat_id_) 
redis:sadd(boos..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(boos..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(boos..'linkGroup'..arg.chat_id_,Gp_Link)
...
if cmd == "Upmonsh" then
if redis:sismember(boos..':MONSHA_Group:'..ChatID,UserID) then 
...
redis:sadd(boos..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮 » تم رفع ❲ "..NameUser.." ❳ منشئ اساسي في المجموعة \n✓️") 
end

if cmd == "Dwmonsh" then
if not redis:sismember(boos..':MONSHA_Group:'..ChatID,UserID) then 
sendMsg(ChatID,MsgID,"📮 » تم بالتأكيد تنزيل ❲ "..NameUser.." ❳ منشئ اساسي في المجموعة \n✓️") 
end
redis:srem(boos..':MONSHA_Group:'..ChatID,UserID) 
...
redis:hset(boos..'username:'..UserID, 'username', Resolv)
redis:sadd(boos..'banned:'..ChatID,UserID)
...
redis:hset(boos..'username:'..UserID, 'username', Resolv)
redis:srem(boos..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
return false
end
...
redis:hset(boos..'username:'..UserID, 'username', Resolv)
redis:sadd(boos..'is_silent_users:'..ChatID,UserID)
...
redis:hset(boos..'username:'..UserID, 'username', Resolv)
redis:srem(boos..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📌 » العضو ❲ "..NameUser.." ❳  تم الغاء كتمه من المجموعة\n✓") 
end

if cmd == "upMshrf" then
  redis:hset(boos..'username:'..UserID,'username',Resolv)
  redis:setex(boos..":uploadingsomeon:"..ChatID..msg.sender_user_id_,500,NameUser)
  redis:setex(boos..":uploadingsomeon2:"..ChatID..msg.sender_user_id_,500,UserID)
...
if cmd == "tfa3l" then  
  local maseegs = redis:get(boos..'msgs:'..UserID..':'..ChatID) or 1
  local edited = redis:get(boos..':edited:'..ChatID..':'..UserID) or 0
  local content = redis:get(boos..':adduser:'..ChatID..':'..UserID) or 0
...
.."\n📝¦ التعديل » "..(redis:get(boos..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗¦ الروابط » "..(redis:get(boos..'lock_link'..msg.chat_id_) or 'false')
.."\n#️⃣¦ التاك » "..(redis:get(boos..'lock_tag'..msg.chat_id_) or 'false')
.."\n©¦ المعرفات » "..(redis:get(boos..'lock_username'..msg.chat_id_) or 'false')
.."\n\n💱¦ التكرار » "..(redis:get(boos..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑¦ الكلايش » "..(redis:get(boos..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐¦ الويب » "..(redis:get(boos..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️¦ الماركدوان » "..(redis:get(boos..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻¦ البوتات بالطرد » "..(redis:get(boos..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖¦ البوتات » "..(redis:get(boos..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕¦ عدد التكرار » "..(redis:get(boos..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n🎬¦` اعدادات الوسائط :`\n"
.."\n🤹*¦* المتحركه » "..(redis:get(boos..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭¦ الدردشه » "..(redis:get(boos..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️¦ الانلاين » "..(redis:get(boos..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮¦ الالعاب » "..(redis:get(boos..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞¦ الصور » "..(redis:get(boos..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥¦ الفيديو » "..(redis:get(boos..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙¦ البصمات » "..(redis:get(boos..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n🔉¦ الصوت » "..(redis:get(boos..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎¦ الملصقات » "..(redis:get(boos..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞¦ الجهات » "..(redis:get(boos..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱¦ التوجيه » "..(redis:get(boos..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐¦ الموقع » "..(redis:get(boos..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂¦ الملفات » "..(redis:get(boos..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅¦ الاشعارات » "..(redis:get(boos..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒¦ الفشار » "..(redis:get(boos..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n🔒¦ الفارسيه » "..(redis:get(boos..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n🔒¦ الانكليزيه » "..(redis:get(boos..'lock_lang'..msg.chat_id_) or 'false')
.."\n🔒¦ الاضافه » "..(redis:get(boos..'lock_join'..msg.chat_id_) or 'false')

local eueuf = "\n\n*⚒¦*` اعدادات اخرى : `"
.."\n*🙋🏼‍♂️¦* الترحيب » "..(redis:get(boos..'welcome:get'..msg.chat_id_) or 'false')
.."\n*💬¦*  الردود » "..(redis:get(boos..'replay'..msg.chat_id_) or 'false')
.."\n*🚸¦*  التحذير » "..(redis:get(boos..'lock_woring'..msg.chat_id_) or 'false')
.."\n*🎫¦* الايدي » "..(redis:get(boos..'lock_id'..msg.chat_id_) or 'false')
.."\n*🎫¦* الرابط » "..(redis:get(boos..'lock_linkk'..msg.chat_id_) or 'false')
.."\n*🎫¦* المغادره » "..(redis:get(boos..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n*🎫¦* الحظر » "..(redis:get(boos..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n*🎫¦* الحمايه » "..(redis:get(boos..'antiedit'..msg.chat_id_) or 'false')
.."\n*🎫¦* التاك للكل » "..(redis:get(boos..'lock_takkl'..msg.chat_id_) or 'false')
.."\n*🎫¦* الايدي بالصوره » "..(redis:get(boos..'idphoto'..msg.chat_id_) or 'false')
.."\n*🎫¦* التحقق » "..(redis:get(boos.."lock_check"..msg.chat_id_) or 'false')
...
.."\n*➕¦* عدد التكرار » "..(redis:get(boos..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n*💱¦*` اعدادات التقـييد :`\n"
.."\n*💢¦* التقييد بالتوجيه » "..(redis:get(boos..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸¦* التقييد بالصور » "..(redis:get(boos..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗¦* التقييد بالروابط » "..(redis:get(boos..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉¦* التقييد بالمتحركه » "..(redis:get(boos..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥¦* التقييد الفيديو » "..(redis:get(boos..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
...
.."\n*🗂¦* الملفات » "..(redis:get(boos..'mute_document'..msg.chat_id_) or 'false')
.."\n*🔅¦* الاشعارات » "..(redis:get(boos..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n*🔒¦* الكيبورد » "..(redis:get(boos..'mute_keyboard'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
return sendMsg(msg.chat_id_,msg.id_,'➖\n'..list_settings..'\n')
end
