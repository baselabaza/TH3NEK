...
if not redis:get(boos.."lock_KickBan"..msg.chat_id_) then 
...
redis:del(boos.."lock_KickBan"..msg.chat_id_) 
...
else redis:set(boos.."idphoto"..msg.chat_id_,true)
...
else redis:set(boos.."lock_woring"..msg.chat_id_,true)
...
redis:set(boos.."lock_id"..msg.chat_id_,true)  
...
else redis:set(boos.."welcome:get"..msg.chat_id_,true)  
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not redis:get(boos.."welcome:get"..msg.chat_id_) then 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:mset(
boos.."lock_username"..msg.chat_id_,true,
boos.."mute_gif"..msg.chat_id_,true,
boos.."mute_photo"..msg.chat_id_,true,
boos.."mute_audio"..msg.chat_id_,true,
boos.."mute_voice"..msg.chat_id_,true,
boos.."mute_sticker"..msg.chat_id_,true,
boos.."mute_forward"..msg.chat_id_,true,
boos.."mute_contact"..msg.chat_id_,true,
boos.."mute_location"..msg.chat_id_,true,
boos.."mute_document"..msg.chat_id_,true,
boos.."lock_link"..msg.chat_id_,true,
boos.."lock_tag"..msg.chat_id_,true,
boos.."lock_edit"..msg.chat_id_,true,
boos.."lock_spam"..msg.chat_id_,true,
boos.."lock_bots"..msg.chat_id_,true,
boos.."lock_webpage"..msg.chat_id_,true,
boos.."mute_video"..msg.chat_id_,true,
boos.."mute_inline"..msg.chat_id_,true
)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:del(
boos.."lock_username"..msg.chat_id_,
boos.."mute_gif"..msg.chat_id_,
boos.."mute_photo"..msg.chat_id_,
boos.."mute_audio"..msg.chat_id_,
boos.."mute_voice"..msg.chat_id_,
boos.."mute_sticker"..msg.chat_id_,
boos.."mute_forward"..msg.chat_id_,
boos.."mute_contact"..msg.chat_id_,
boos.."mute_location"..msg.chat_id_,
boos.."mute_document"..msg.chat_id_,
boos.."lock_link"..msg.chat_id_,
boos.."lock_tag"..msg.chat_id_,
boos.."lock_edit"..msg.chat_id_,
boos.."lock_spam"..msg.chat_id_,
boos.."lock_bots"..msg.chat_id_,
boos.."lock_webpage"..msg.chat_id_,
boos.."mute_video"..msg.chat_id_,
boos..":tqeed_video:"..msg.chat_id_,
boos..":tqeed_photo:"..msg.chat_id_,
boos..":tqeed_gif:"..msg.chat_id_,
boos..":tqeed_fwd:"..msg.chat_id_,
boos..":tqeed_link:"..msg.chat_id_,
boos.."mute_inline"..msg.chat_id_
)
...
if redis:get(boos..":tqeed_photo:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد بالصور بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(boos.."mute_photo"..msg.chat_id_)
redis:set(boos..":tqeed_photo:"..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(boos..":tqeed_video:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد بالفيديو بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(boos..":tqeed_video:"..msg.chat_id_)
redis:set(boos..":tqeed_video:"..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if not redis:get(boos..":tqeed_video:"..msg.chat_id_) then
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(boos..":tqeed_gif:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد الممتحركه بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(boos.."mute_gif"..msg.chat_id_)
redis:set(boos..":tqeed_gif:"..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(boos..":tqeed_fwd:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد بالتوجيه بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(boos.."mute_forward"..msg.chat_id_)
redis:set(boos..":tqeed_fwd:"..msg.chat_id_,true)
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(boos.."lock_bots"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." البوتات بالتأكيد تم فتحها \n✓",16,utf8.len(msg.TheRankCmd)) 
else 
redis:del(boos.."lock_bots_by_kick"..msg.chat_id_)
redis:del(boos.."lock_bots"..msg.chat_id_)
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(boos.."mute_gif"..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(boos.."mute_game"..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(boos.."mute_photo"..msg.chat_id_)then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(boos.."mute_forward"..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(boos.."lock_bots_by_kick"..msg.chat_id_) then
